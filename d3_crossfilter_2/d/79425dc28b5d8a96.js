...
data.dimension(d => d.dtg)
)});
  main.variable(observer("magnitudeDimension")).define("magnitudeDimension", ["data"], function(data){return(
data.dimension(d => d.magnitude)
)});
...
magnitudeDimension.group()
  ...
  main.variable(observer("depthDimension")).define("depthDimension", ["data"], function(data){return(
data.dimension(d => d.depth)
)});
  main.variable(observer("depthGroup")).define("depthGroup", ["depthDimension"], function(depthDimension){return(
depthDimension.group()
)});
  main.variable(observer("timeDimension")).define("timeDimension", ["data","d3"], function(data,d3){return(
data.dimension((d) => d3.timeHour(d.dtg))
)});
