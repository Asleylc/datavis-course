...
dateDim.group().reduceSum(d => d.facebook)
  ...
  main.variable(observer("googleByPercentage")).define("googleByPercentage", ["dateDim","dataset"], function(dateDim,dataset){return(
dateDim.group().reduceSum(d => 100*(d.google/dataset[0]['google']-1))
)});
  main.variable(observer("fbByPercentage")).define("fbByPercentage", ["dateDim","dataset"], function(dateDim,dataset){return(
dateDim.group().reduceSum(d => 100*(d.facebook/dataset[0]['facebook']-1))
)});
...
require("d3")
  ...
  main.variable(observer("acoes")).define("acoes", ["md","container","dc","d3","dateDim","googleByPercentage","fbByPercentage"], function(md,container,dc,d3,dateDim,googleByPercentage,fbByPercentage)
{
...
d3.json("https://raw.githubusercontent.com/emanueles/datavis-course/master/assets/files/observable/movies.json")
  ...
  main.variable(observer("factsMovie")).define("factsMovie", ["crossfilter","datasetMovies"], function(crossfilter,datasetMovies){return(
crossfilter(datasetMovies)
)});
  main.variable(observer("year_Dim")).define("year_Dim", ["factsMovie"], function(factsMovie){return(
factsMovie.dimension(d => d.Year)
)});
  main.variable(observer("genre_Dim")).define("genre_Dim", ["factsMovie"], function(factsMovie){return(
factsMovie.dimension(d => d.Genre)
)});
  main.variable(observer("GroupGenreGross")).define("GroupGenreGross", ["genre_Dim"], function(genre_Dim){return(
genre_Dim.group().reduceSum(d => d.Worldwide_Gross_M)
)});
  main.variable(observer("GroupYearGross")).define("GroupYearGross", ["year_Dim"], function(year_Dim){return(
year_Dim.group().reduceSum(d => d.Worldwide_Gross_M)
)});
  main.variable(observer("by_year")).define("by_year", ["md","container","dc","year_Dim","GroupYearGross","d3"], function(md,container,dc,year_Dim,GroupYearGross,d3)
{
  ...
  main.variable(observer("by_genre")).define("by_genre", ["md","container","dc","genre_Dim","GroupGenreGross","d3"], function(md,container,dc,genre_Dim,GroupGenreGross,d3)
{
